...
<asp:Content runat="server" ContentPlaceHolderID="content">
    ...
    <article>
        ...
        <map name="Map" id="Map">
            ...
            <area shape="rect" coords="123,77,208,94" href="<%= ConfigurationManager.AppSettings["UmbracoBaseUrl"] %>/libraries/locations/crowborough/" alt="Crowborough" title="Crowborough" />
            <area shape="rect" coords="197,94,264,112" href="<%= ConfigurationManager.AppSettings["UmbracoBaseUrl"] %>/libraries/locations/mayfield/" alt="Mayfield" title="Mayfield" />
            <area shape="rect" coords="102,129,180,158" href="<%= ConfigurationManager.AppSettings["UmbracoBaseUrl"] %>/libraries/locations/uckfield/" alt="Uckfield" title="Uckfield" />
            ...
            <area shape="rect" coords="9,276,80,304" href="<%= ConfigurationManager.AppSettings["UmbracoBaseUrl"] %>/libraries/locations/peacehaven/" alt="Peacehaven" title="Peacehaven" />
            <area shape="rect" coords="81,277,147,303" href="<%= ConfigurationManager.AppSettings["UmbracoBaseUrl"] %>/libraries/locations/newhaven/" alt="Newhaven" title="Newhaven" />
            <area shape="rect" coords="117,302,164,325" href="<%= ConfigurationManager.AppSettings["UmbracoBaseUrl"] %>/libraries/locations/seaford/" alt="Seaford" title="Seaford" />
            <area shape="poly" coords="206,327,207,344,140,344,143,327,168,326,160,270,177,270,175,324" href="<%= ConfigurationManager.AppSettings["UmbracoBaseUrl"] %>/libraries/locations/willingdon/" alt="Willingdon" title="Willingdon" />
            <area shape="poly" coords="179,300,179,322,258,324,258,310" href="<%= ConfigurationManager.AppSettings["UmbracoBaseUrl"] %>/libraries/locations/eastbourne/" alt="Eastbourne" title="Eastbourne" />
            ...
            <area shape="rect" coords="315,190,399,206" href="<%= ConfigurationManager.AppSettings["UmbracoBaseUrl"] %>/libraries/locations/hollington/" alt="Hollington" title="Hollington" />
            ...
            <area shape="rect" coords="170,247,240,267" href="<%= ConfigurationManager.AppSettings["UmbracoBaseUrl"] %>/libraries/locations/polegate/" alt="Polegate" title="Polegate" />
            <area shape="poly" coords="306,309,306,290,243,290,201,274,198,286,244,307" href="<%= ConfigurationManager.AppSettings["UmbracoBaseUrl"] %>/libraries/locations/langney/" alt="Langney" title="Langney" />
            ...
            <area shape="poly" coords="322,267,259,263,242,257,241,245,262,255,319,253" href="<%= ConfigurationManager.AppSettings["UmbracoBaseUrl"] %>/libraries/locations/pevenseybay/" alt="Pevensey Bay" title="Pevensey Bay" />
            <area shape="poly" coords="391,160,400,160,400,167,426,168,426,145,390,143,386,158" href="<%= ConfigurationManager.AppSettings["UmbracoBaseUrl"] %>/libraries/locations/rye/" alt="Rye" title="Rye" />
            <area shape="poly" coords="191,266,321,267,320,288,241,289,200,273,187,277" href="<%= ConfigurationManager.AppSettings["UmbracoBaseUrl"] %>/libraries/locations/hampdenpark/" alt="Hampden Park" title="Hampden Park" />
